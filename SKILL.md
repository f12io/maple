...
| `border-beam`     | Animated border beam        | `--beam-offset` (default: `1px`)<br>`--beam-radius` (default: `inherit`)<br>`--beam-width` (default: `1px`)<br>`--beam-opacity` (default: `1`)<br>`--beam-core-color` (default: `currentColor`)<br>`--beam-glow-color` (default: `color-mix(in oklch, currentColor 75%, transparent)`) | `anim-border-beam_2500_linear_infinite`              |
