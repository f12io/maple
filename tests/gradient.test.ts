...
describe('Linear', () => {
  ...
  it('linear with two stops without direction', () => {
    expect(convert('bgimg-linear|red|blue')).toBe(
      `.bgimg-linear\\|red\\|blue { background-image: linear-gradient(oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), oklch(from var(--bgc-blue, var(--color-blue, var(--blue, blue))) calc(l * var(--bgc-blue-l-scale, var(--blue-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-blue-c-scale, var(--blue-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-blue-h-rotate, var(--blue-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha)); }`,
    );
  });
  ...
  it('repeating-linear with two stops without direction', () => {
    expect(convert('bgimg-rlinear|red|blue')).toBe(
      `.bgimg-rlinear\\|red\\|blue { background-image: repeating-linear-gradient(oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), oklch(from var(--bgc-blue, var(--color-blue, var(--blue, blue))) calc(l * var(--bgc-blue-l-scale, var(--blue-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-blue-c-scale, var(--blue-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-blue-h-rotate, var(--blue-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha)); }`,
    );
  });

  it('linear multiple gradients with two colors', () => {
    expect(convert('bgimg-linear|red|blue,radial|green|transparent')).toBe(
      `.bgimg-linear\\|red\\|blue\\,radial\\|green\\|transparent { background-image: linear-gradient(oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), oklch(from var(--bgc-blue, var(--color-blue, var(--blue, blue))) calc(l * var(--bgc-blue-l-scale, var(--blue-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-blue-c-scale, var(--blue-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-blue-h-rotate, var(--blue-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha)), radial-gradient(oklch(from var(--bgc-green, var(--color-green, var(--green, green))) calc(l * var(--bgc-green-l-scale, var(--green-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-green-c-scale, var(--green-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-green-h-rotate, var(--green-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), transparent); }`,
    );
  });
  ...
  it('linear gradient with direction, alpa and stop', () => {
    expect(
      ...
      `.bgimg-linear\\|to_top\\|primary\\/50_50\\%\\|red\\|transparent_0\\|transparent { background-image: linear-gradient(to top, oklch(from var(--bgc-primary, var(--color-primary, var(--primary, primary))) calc(l * var(--bgc-primary-l-scale, var(--primary-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-primary-c-scale, var(--primary-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-primary-h-rotate, var(--primary-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / 50%) 50%, oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), transparent 0, transparent); }`,
    );
  });
...
describe('Radial', () => {
  ...
  it('radial with two stops without direction', () => {
    expect(convert('bgimg-radial|red|blue')).toBe(
      `.bgimg-radial\\|red\\|blue { background-image: radial-gradient(oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), oklch(from var(--bgc-blue, var(--color-blue, var(--blue, blue))) calc(l * var(--bgc-blue-l-scale, var(--blue-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-blue-c-scale, var(--blue-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-blue-h-rotate, var(--blue-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha)); }`,
    );
  });

  it('repeating-radial with two stops without direction', () => {
    expect(convert('bgimg-rradial|red|blue')).toBe(
      `.bgimg-rradial\\|red\\|blue { background-image: repeating-radial-gradient(oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), oklch(from var(--bgc-blue, var(--color-blue, var(--blue, blue))) calc(l * var(--bgc-blue-l-scale, var(--blue-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-blue-c-scale, var(--blue-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-blue-h-rotate, var(--blue-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha)); }`,
    );
  });

  it('radial multiple gradients with two colors', () => {
    expect(convert('bgimg-radial|red|blue,radial|green|transparent')).toBe(
      `.bgimg-radial\\|red\\|blue\\,radial\\|green\\|transparent { background-image: radial-gradient(oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), oklch(from var(--bgc-blue, var(--color-blue, var(--blue, blue))) calc(l * var(--bgc-blue-l-scale, var(--blue-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-blue-c-scale, var(--blue-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-blue-h-rotate, var(--blue-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha)), radial-gradient(oklch(from var(--bgc-green, var(--color-green, var(--green, green))) calc(l * var(--bgc-green-l-scale, var(--green-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-green-c-scale, var(--green-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-green-h-rotate, var(--green-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), transparent); }`,
    );
  });
  ...
  it('radial gradient with direction, alpa and stop', () => {
    expect(
      ...
      `.bgimg-radial\\|closest-side\\|primary\\/50_50\\%\\|red\\|transparent_0\\|transparent { background-image: radial-gradient(closest-side, oklch(from var(--bgc-primary, var(--color-primary, var(--primary, primary))) calc(l * var(--bgc-primary-l-scale, var(--primary-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-primary-c-scale, var(--primary-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-primary-h-rotate, var(--primary-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / 50%) 50%, oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), transparent 0, transparent); }`,
    );
  });
  ...
  it('radial gradient', () => {
    expect(convert('bgimg-radial|10deg|red|transparent')).toBe(
      `.bgimg-radial\\|10deg\\|red\\|transparent { background-image: radial-gradient(10deg, oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), transparent); }`,
    );
  });
  ...
  it('radial gradient with direction', () => {
    expect(
      ...
      `.bgimg-radial\\|circle_at_center_in_hsl_longer_hue\\|red\\|transparent { background-image: radial-gradient(circle at center in hsl longer hue, oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), transparent); }`,
    );
  });
...
describe('Conic', () => {
  ...
  it('conic with variable', () => {
    expect(convert('bgimg-conic|primary|secondary')).toBe(
      `.bgimg-conic\\|primary\\|secondary { background-image: conic-gradient(oklch(from var(--bgc-primary, var(--color-primary, var(--primary, primary))) calc(l * var(--bgc-primary-l-scale, var(--primary-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-primary-c-scale, var(--primary-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-primary-h-rotate, var(--primary-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), oklch(from var(--bgc-secondary, var(--color-secondary, var(--secondary, secondary))) calc(l * var(--bgc-secondary-l-scale, var(--secondary-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-secondary-c-scale, var(--secondary-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-secondary-h-rotate, var(--secondary-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha)); }`,
    );
  });

  it('conic with dashed variable names', () => {
    expect(convert('bgimg-conic|brand-blue|accent-orange')).toBe(
      `.bgimg-conic\\|brand-blue\\|accent-orange { background-image: conic-gradient(oklch(from var(--bgc-brand-blue, var(--color-brand-blue, var(--brand-blue, brand-blue))) calc(l * var(--bgc-brand-blue-l-scale, var(--brand-blue-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-brand-blue-c-scale, var(--brand-blue-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-brand-blue-h-rotate, var(--brand-blue-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), oklch(from var(--bgc-accent-orange, var(--color-accent-orange, var(--accent-orange, accent-orange))) calc(l * var(--bgc-accent-orange-l-scale, var(--accent-orange-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-accent-orange-c-scale, var(--accent-orange-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-accent-orange-h-rotate, var(--accent-orange-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha)); }`,
    );
  });

  it('conic with two stops without direction', () => {
    expect(convert('bgimg-conic|red|blue')).toBe(
      `.bgimg-conic\\|red\\|blue { background-image: conic-gradient(oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), oklch(from var(--bgc-blue, var(--color-blue, var(--blue, blue))) calc(l * var(--bgc-blue-l-scale, var(--blue-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-blue-c-scale, var(--blue-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-blue-h-rotate, var(--blue-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha)); }`,
    );
  });
  ...
  it('conic multiple gradients with two colors', () => {
    expect(convert('bgimg-conic|red|blue,conic|green|transparent')).toBe(
      `.bgimg-conic\\|red\\|blue\\,conic\\|green\\|transparent { background-image: conic-gradient(oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), oklch(from var(--bgc-blue, var(--color-blue, var(--blue, blue))) calc(l * var(--bgc-blue-l-scale, var(--blue-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-blue-c-scale, var(--blue-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-blue-h-rotate, var(--blue-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha)), conic-gradient(oklch(from var(--bgc-green, var(--color-green, var(--green, green))) calc(l * var(--bgc-green-l-scale, var(--green-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-green-c-scale, var(--green-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-green-h-rotate, var(--green-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), transparent); }`,
    );
  });
  ...
  it('conic gradient with direction, alpa and stop', () => {
    expect(
      ...
      `.bgimg-conic\\|from_40deg\\|primary\\/50_180deg\\|red\\|transparent_0\\|transparent { background-image: conic-gradient(from 40deg, oklch(from var(--bgc-primary, var(--color-primary, var(--primary, primary))) calc(l * var(--bgc-primary-l-scale, var(--primary-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-primary-c-scale, var(--primary-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-primary-h-rotate, var(--primary-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / 50%) 180deg, oklch(from var(--bgc-red, var(--color-red, var(--red, red))) calc(l * var(--bgc-red-l-scale, var(--red-l-scale, var(--bgc-l-scale, var(--l-scale, 1))))) calc(c * var(--bgc-red-c-scale, var(--red-c-scale, var(--bgc-c-scale, var(--c-scale, 1))))) calc(h + var(--bgc-red-h-rotate, var(--red-h-rotate, var(--bgc-h-rotate, var(--h-rotate, 0))))) / alpha), transparent 0, transparent); }`,
    );
  });
