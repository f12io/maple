...
describe('Drop Shadow', () => {
  ...
  it('drop-shadow with multiple known variables', () => {
    ...
    expect(convert('bdshadow-0px_1px_red')).toBe(
      `.bdshadow-0px_1px_red { --filter-bdshadow: drop-shadow(0px 1px oklch(from var(--dshadow-red, var(--shadow-red, var(--color-red, var(--red, red)))) calc(l * var(--dshadow-red-l-scale, var(--red-l-scale, var(--dshadow-l-scale, var(--l-scale, 1))))) calc(c * var(--dshadow-red-c-scale, var(--red-c-scale, var(--dshadow-c-scale, var(--c-scale, 1))))) calc(h + var(--dshadow-red-h-rotate, var(--red-h-rotate, var(--dshadow-h-rotate, var(--h-rotate, 0))))) / alpha));${vars}; }`,
    );
    expect(convert('bdshadow-0px_1px_0px_red')).toBe(
      `.bdshadow-0px_1px_0px_red { --filter-bdshadow: drop-shadow(0px 1px 0px oklch(from var(--dshadow-red, var(--shadow-red, var(--color-red, var(--red, red)))) calc(l * var(--dshadow-red-l-scale, var(--red-l-scale, var(--dshadow-l-scale, var(--l-scale, 1))))) calc(c * var(--dshadow-red-c-scale, var(--red-c-scale, var(--dshadow-c-scale, var(--c-scale, 1))))) calc(h + var(--dshadow-red-h-rotate, var(--red-h-rotate, var(--dshadow-h-rotate, var(--h-rotate, 0))))) / alpha));${vars}; }`,
    );
  ...
  it('drop-shadow known and unknown variables', () => {
    expect(convert('bdshadow-2xs_red')).toBe(
      `.bdshadow-2xs_red { --filter-bdshadow: drop-shadow(var(--dshadow-2xs, var(--shadow-2xs, var(--2xs, 2xs))) oklch(from var(--dshadow-red, var(--shadow-red, var(--color-red, var(--red, red)))) calc(l * var(--dshadow-red-l-scale, var(--red-l-scale, var(--dshadow-l-scale, var(--l-scale, 1))))) calc(c * var(--dshadow-red-c-scale, var(--red-c-scale, var(--dshadow-c-scale, var(--c-scale, 1))))) calc(h + var(--dshadow-red-h-rotate, var(--red-h-rotate, var(--dshadow-h-rotate, var(--h-rotate, 0))))) / alpha));${vars}; }`,
    );

    expect(convert('bdshadow-2xs_px_red')).toBe(
      `.bdshadow-2xs_px_red { --filter-bdshadow: drop-shadow(var(--dshadow-2xs, var(--shadow-2xs, var(--2xs, 2xs))) 1px oklch(from var(--dshadow-red, var(--shadow-red, var(--color-red, var(--red, red)))) calc(l * var(--dshadow-red-l-scale, var(--red-l-scale, var(--dshadow-l-scale, var(--l-scale, 1))))) calc(c * var(--dshadow-red-c-scale, var(--red-c-scale, var(--dshadow-c-scale, var(--c-scale, 1))))) calc(h + var(--dshadow-red-h-rotate, var(--red-h-rotate, var(--dshadow-h-rotate, var(--h-rotate, 0))))) / alpha));${vars}; }`,
    );
  });
