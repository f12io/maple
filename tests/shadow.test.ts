...
describe('Text Shadow', () => {
  ...
  it('text-shadow with multiple known variables', () => {
    ...
    expect(convert('tshadow-0px_1px_red')).toBe(
      `.tshadow-0px_1px_red { text-shadow: 0px 1px oklch(from var(--tshadow-red, var(--shadow-red, var(--color-red, var(--red, red)))) calc(l * var(--tshadow-red-l-scale, var(--red-l-scale, var(--tshadow-l-scale, var(--l-scale, 1))))) calc(c * var(--tshadow-red-c-scale, var(--red-c-scale, var(--tshadow-c-scale, var(--c-scale, 1))))) calc(h + var(--tshadow-red-h-rotate, var(--red-h-rotate, var(--tshadow-h-rotate, var(--h-rotate, 0))))) / alpha); }`,
    );
    expect(convert('tshadow-0px_1px_0px_red')).toBe(
      `.tshadow-0px_1px_0px_red { text-shadow: 0px 1px 0px oklch(from var(--tshadow-red, var(--shadow-red, var(--color-red, var(--red, red)))) calc(l * var(--tshadow-red-l-scale, var(--red-l-scale, var(--tshadow-l-scale, var(--l-scale, 1))))) calc(c * var(--tshadow-red-c-scale, var(--red-c-scale, var(--tshadow-c-scale, var(--c-scale, 1))))) calc(h + var(--tshadow-red-h-rotate, var(--red-h-rotate, var(--tshadow-h-rotate, var(--h-rotate, 0))))) / alpha); }`,
    );
    expect(convert('tshadow-0_1_0_red')).toBe(
      `.tshadow-0_1_0_red { text-shadow: 0 var(--tshadow-1, var(--space-1, calc(1rem * var(--tshadow-spacer, var(--shadow-spacer, var(--spacer, 0.25)))))) 0 oklch(from var(--tshadow-red, var(--shadow-red, var(--color-red, var(--red, red)))) calc(l * var(--tshadow-red-l-scale, var(--red-l-scale, var(--tshadow-l-scale, var(--l-scale, 1))))) calc(c * var(--tshadow-red-c-scale, var(--red-c-scale, var(--tshadow-c-scale, var(--c-scale, 1))))) calc(h + var(--tshadow-red-h-rotate, var(--red-h-rotate, var(--tshadow-h-rotate, var(--h-rotate, 0))))) / alpha); }`,
    );
  });

  it('text-shadow known and unknown variables', () => {
    expect(convert('tshadow-2xs_red')).toBe(
      `.tshadow-2xs_red { text-shadow: var(--tshadow-2xs, var(--shadow-2xs, var(--2xs, 2xs))) oklch(from var(--tshadow-red, var(--shadow-red, var(--color-red, var(--red, red)))) calc(l * var(--tshadow-red-l-scale, var(--red-l-scale, var(--tshadow-l-scale, var(--l-scale, 1))))) calc(c * var(--tshadow-red-c-scale, var(--red-c-scale, var(--tshadow-c-scale, var(--c-scale, 1))))) calc(h + var(--tshadow-red-h-rotate, var(--red-h-rotate, var(--tshadow-h-rotate, var(--h-rotate, 0))))) / alpha); }`,
    );

    expect(convert('tshadow-2xs_px_red')).toBe(
      `.tshadow-2xs_px_red { text-shadow: var(--tshadow-2xs, var(--shadow-2xs, var(--2xs, 2xs))) 1px oklch(from var(--tshadow-red, var(--shadow-red, var(--color-red, var(--red, red)))) calc(l * var(--tshadow-red-l-scale, var(--red-l-scale, var(--tshadow-l-scale, var(--l-scale, 1))))) calc(c * var(--tshadow-red-c-scale, var(--red-c-scale, var(--tshadow-c-scale, var(--c-scale, 1))))) calc(h + var(--tshadow-red-h-rotate, var(--red-h-rotate, var(--tshadow-h-rotate, var(--h-rotate, 0))))) / alpha); }`,
    );
  });
...
describe('Box Shadow', () => {
  ...
  it('box-shadow with multiple known variables', () => {
    ...
    expect(convert('bshadow-0px_1px_red')).toBe(
      `.bshadow-0px_1px_red { box-shadow: 0px 1px oklch(from var(--bshadow-red, var(--shadow-red, var(--color-red, var(--red, red)))) calc(l * var(--bshadow-red-l-scale, var(--red-l-scale, var(--bshadow-l-scale, var(--l-scale, 1))))) calc(c * var(--bshadow-red-c-scale, var(--red-c-scale, var(--bshadow-c-scale, var(--c-scale, 1))))) calc(h + var(--bshadow-red-h-rotate, var(--red-h-rotate, var(--bshadow-h-rotate, var(--h-rotate, 0))))) / alpha); }`,
    );
