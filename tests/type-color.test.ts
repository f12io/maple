...
describe('Color', () => {
  ...
  it('text color with dashed custom variable and lightness', () => {
    expect(convert('c-brand-blue-600')).toBe(
      '.c-brand-blue-600 { color: oklch(from var(--c-brand-blue, var(--color-brand-blue, var(--brand-blue, brand-blue))) calc((l + l * -0.2) * var(--c-brand-blue-lightness-factor, var(--brand-blue-lightness-factor, var(--c-lightness-factor, var(--lightness-factor, 1))))) calc(c * var(--c-brand-blue-chroma-factor, var(--brand-blue-chroma-factor, var(--c-chroma-factor, var(--chroma-factor, 1))))) calc(h + var(--c-brand-blue-hue-rotate, var(--brand-blue-hue-rotate, var(--c-hue-rotate, var(--hue-rotate, 0))))) / alpha); }',
    );
  });

  it('text color with dashed custom variable, lightness and alpha', () => {
    expect(convert('c-brand-blue-600/50')).toBe(
      '.c-brand-blue-600\\/50 { color: oklch(from var(--c-brand-blue, var(--color-brand-blue, var(--brand-blue, brand-blue))) calc((l + l * -0.2) * var(--c-brand-blue-lightness-factor, var(--brand-blue-lightness-factor, var(--c-lightness-factor, var(--lightness-factor, 1))))) calc(c * var(--c-brand-blue-chroma-factor, var(--brand-blue-chroma-factor, var(--c-chroma-factor, var(--chroma-factor, 1))))) calc(h + var(--c-brand-blue-hue-rotate, var(--brand-blue-hue-rotate, var(--c-hue-rotate, var(--hue-rotate, 0))))) / 50%); }',
    );
  });
  ...
  it('background color', () => {
    expect(convert('bgc-blue-600')).toBe(
      '.bgc-blue-600 { background-color: oklch(from var(--bgc-blue, var(--color-blue, var(--blue, blue))) calc((l + l * -0.2) * var(--bgc-blue-lightness-factor, var(--blue-lightness-factor, var(--bgc-lightness-factor, var(--lightness-factor, 1))))) calc(c * var(--bgc-blue-chroma-factor, var(--blue-chroma-factor, var(--bgc-chroma-factor, var(--chroma-factor, 1))))) calc(h + var(--bgc-blue-hue-rotate, var(--blue-hue-rotate, var(--bgc-hue-rotate, var(--hue-rotate, 0))))) / alpha); }',
    );
  });
  ...
  it('border color', () => {
    expect(convert('brc-gray-300')).toBe(
      '.brc-gray-300 { border-color: oklch(from var(--brc-gray, var(--color-gray, var(--gray, gray))) calc((l + (1 - l) * 0.4) * var(--brc-gray-lightness-factor, var(--gray-lightness-factor, var(--brc-lightness-factor, var(--lightness-factor, 1))))) calc(c * var(--brc-gray-chroma-factor, var(--gray-chroma-factor, var(--brc-chroma-factor, var(--chroma-factor, 1))))) calc(h + var(--brc-gray-hue-rotate, var(--gray-hue-rotate, var(--brc-hue-rotate, var(--hue-rotate, 0))))) / alpha); }',
    );
  });

  it('border color multiple values', () => {
    expect(convert('brc-gray-300_blue-200')).toBe(
      '.brc-gray-300_blue-200 { border-color: oklch(from var(--brc-gray, var(--color-gray, var(--gray, gray))) calc((l + (1 - l) * 0.4) * var(--brc-gray-lightness-factor, var(--gray-lightness-factor, var(--brc-lightness-factor, var(--lightness-factor, 1))))) calc(c * var(--brc-gray-chroma-factor, var(--gray-chroma-factor, var(--brc-chroma-factor, var(--chroma-factor, 1))))) calc(h + var(--brc-gray-hue-rotate, var(--gray-hue-rotate, var(--brc-hue-rotate, var(--hue-rotate, 0))))) / alpha) oklch(from var(--brc-blue, var(--color-blue, var(--blue, blue))) calc((l + (1 - l) * 0.6) * var(--brc-blue-lightness-factor, var(--blue-lightness-factor, var(--brc-lightness-factor, var(--lightness-factor, 1))))) calc(c * var(--brc-blue-chroma-factor, var(--blue-chroma-factor, var(--brc-chroma-factor, var(--chroma-factor, 1))))) calc(h + var(--brc-blue-hue-rotate, var(--blue-hue-rotate, var(--brc-hue-rotate, var(--hue-rotate, 0))))) / alpha); }',
    );
  });

  it('border color multiple values with custom value', () => {
    expect(convert('brc-gray-300_[red]')).toBe(
      '.brc-gray-300_\\[red\\] { border-color: oklch(from var(--brc-gray, var(--color-gray, var(--gray, gray))) calc((l + (1 - l) * 0.4) * var(--brc-gray-lightness-factor, var(--gray-lightness-factor, var(--brc-lightness-factor, var(--lightness-factor, 1))))) calc(c * var(--brc-gray-chroma-factor, var(--gray-chroma-factor, var(--brc-chroma-factor, var(--chroma-factor, 1))))) calc(h + var(--brc-gray-hue-rotate, var(--gray-hue-rotate, var(--brc-hue-rotate, var(--hue-rotate, 0))))) / alpha) red; }',
    );
  });
